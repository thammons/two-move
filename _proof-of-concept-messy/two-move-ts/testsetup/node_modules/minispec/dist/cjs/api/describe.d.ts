 ...
 * @see {@link context}
 */
declare function describe(name: string, code: () => Promise<void>): void;
declare namespace describe {
    var f: typeof fdescribe;
    var focus: typeof fdescribe;
    var x: typeof xdescribe;
    var ignores: typeof xdescribe;
    var s: typeof sdescribe;
    var skip: typeof sdescribe;
}
/**
 ...
 * @see {@link describe.ignores}
 */
export declare function fdescribe(name: string, code: () => Promise<void>): void;
/**
 ...
 * @see {@link context}
 */
export declare function sdescribe(name: string, code: () => Promise<void>): void;
/**
 ...
 * @see {@link describe}
 */
export declare function xdescribe(_name: string, _code: () => Promise<void>): void;
